...
data = {'ds' : [datetime.date(k, 1, 1) for k in range(1993, 2019)], 'y' : m2_1er_93_13 + [9800, 9900, 10710, 11740, 12060]}
#data = {'ds' : [datetime.date(k, 1, 1) for k in range(1993, 2019)], 'y' : m2_1er_93_13 + [master_cadrille["mean_price"][where x=..., y=...], 8100, 8900, 9500, 10200]}
df = pd.DataFrame(data, columns = ['ds', 'y'])

m = Prophet()
m.fit(df)
future_years = m.make_future_dataframe(periods = 20, freq = 'Y')
